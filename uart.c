...
int main ()
{
	...
	//		close(fd);
		...
		if( strcmp(buff,"11") == 0 || strcmp(buff,"11") == 0 || strcmp(buff,"12") == 0 || strcmp(buff,"120") == 0 || strcmp(buff,"130") == 0
		 || strcmp(buff,"13") == 0 || strcmp(buff,"14") == 0 || strcmp(buff,"14") == 0 || strcmp(buff,"210") == 0 || strcmp(buff,"211") == 0
		 || strcmp(buff,"220") == 0 || strcmp(buff,"221") == 0 || strcmp(buff,"230") == 0 || strcmp(buff,"231") == 0 || strcmp(buff,"240") == 0
		 || strcmp(buff,"241") == 0 || strcmp(buff,"250") == 0 || strcmp(buff,"251") == 0 || strcmp(buff,"310") == 0 || strcmp(buff,"311") == 0
		 || strcmp(buff,"320") == 0 || strcmp(buff,"321") == 0 || strcmp(buff,"330") == 0 || strcmp(buff,"331") == 0 || strcmp(buff,"340") == 0

...
//			printf("inp 1 =  %d \n" , inhale_time + exhale_time);
	...
	//			printf(" Final Compliance ====================================  %f \n " , final_compliance);
			...
			Exhale_flag = false;										//
			sprintf(d_string, "D@%.2f,%.2f,%d,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f#", pressure_insp , final_rr , 21 ,(-1)*Pef_exp ,(-1)*MVe/1000.00 ,  leak ,mean_airway_pressure , Ve*-1 ,cmv_exp_time/1000.00); //lakshay
			printf("%s  \n", d_string);
			printf("data ============== %d \n ", strlen(d_string));
